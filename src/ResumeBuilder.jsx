...
function ResumeBuilder(){
    ...
    <div className="Main">
      <section className="HeadArticle">
        ...
        <img  className="HeadImage col-lg-6"src={heroCard} alt={step4}></img>
      </section>
      ...
      <section className="Card">
        ...
        <div className="templatesection">
          ...
          <button className="HoverButton">Use This Template</button>
          <p>Cubic</p>
...
<button className="HoverButton">Use This Template</button>
      ...
      <section className="HeadArticle">
      <img  className="HeadImage col-lg-6"src={image1} alt={step4}></img>
        <div className="HeadCard col-lg-6">
      ...
      <section className="HeadArticle">
        ...
        <img  className="HeadImage col-lg-6"src={image2} alt={step4}></img>
      </section><hr style={{margin:"70px"}}></hr>
      <section className="HeadArticle">
      <img  className="HeadImage col-lg-6"src={image3} alt={step4}></img>
        <div className="HeadCard col-lg-6">
      ...
      <section className="HeadArticle">
        ...
        <img  className="HeadImage col-lg-6"src={image4} alt={step4}></img>
      </section><hr style={{margin:"70px"}}></hr>
      <section className="HeadArticle">
      <img  className="HeadImage col-lg-6"src={image5} alt={step4}></img>
        <div className="HeadCard col-lg-6">
      ...
      <section className="HeadArticle">
        ...
        <img  className="HeadImage col-lg-6"src={image7} alt={step4}></img>
      </section>
      <h1>Build your resume with resume examples created by Certified Professional Resume Writers.</h1>
      <p>Explore our extensive collection of over 600 tailored resume examples designed for every job and industry. Our team of career experts has crafted each guide to include a comprehensive example and valuable tips for every resume section tailored to your specific profession. For an even easier process, use our online resume builder. Simply input your job title, and let us take care of the rest. Create your resume quickly and easily, and get the dream job you've always wanted.

Project Manager Resume
Project Manager Resume
Master the art of showcasing your leadership skills and project successes with our Project Manager Resume guide, designed to help you stand out in your field.

Customer Service Resume
Customer Service Resume
Highlight your exceptional communication and problem-solving abilities with our Customer Service Resume guide, crafted to elevate your job application.
...
<button className="Button">Create your Fast Resume Builder</button>
    ...
    <hr style={{margin:"70px"}}></hr>
    <h2>Which resume builder is the best in 2024?</h2>
    <h3>Zety's resume maker is the best resume builder in 2024. It offers more features than any other app of such kind. It also allows you to create as many documents as you want for free, providing:</h3>
    <div className="lists">
    <ul>
